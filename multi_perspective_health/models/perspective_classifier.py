...
class PerspectiveClassifier(nn.Module):
    def __init__(self, model_name: str = "dmis-lab/biobert-base-cased-v1.1", num_labels: int = 3):
        """
        Args:
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, labels=None):
        ...
        Args:
            ...
            labels: (batch_size,) - gold class labels

        Returns:
            If labels provided: loss (cross-entropy)
